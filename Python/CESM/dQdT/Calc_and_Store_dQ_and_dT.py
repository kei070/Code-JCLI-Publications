...
# output path
out_path = data_path + case + "/dQ_and_dT_Files/"
...
for yri, i in enumerate(np.arange(sta_yr, int(n_yr*12), 12)):
    ...
    # set output name
    out_name =  "dQ_and_dT_CESM2-SOM_" + case + "_" + f'{yr:04}' + "01" + "-" + f'{yr:04}' + "12" + ".nc"
    ...
    f.description = ("This file contains the monthly Q and T change as well as RH. Note that the " +
                     "piControl values of ta and hus have previously been averaged as a 28-year climatology." )
