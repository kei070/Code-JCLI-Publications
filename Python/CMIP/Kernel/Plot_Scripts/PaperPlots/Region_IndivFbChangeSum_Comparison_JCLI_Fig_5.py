...
ax1.legend(loc="lower right", title="Feedbacks", fontsize=15, title_fontsize=17)
...
ax1.legend(loc="lower right", title="Feedbacks", fontsize=14, title_fontsize=15, ncol=3)
